export default function ScheduleItem(props) {
    ...
    let textDisplayClasses = "col-lg-8 col-md-8 col-sm-8 border-top border-dark text-left align-middle text-dark pt-1 mt-1";
    ...
    return (
        <div className="row p-1" time={item.time} _id={item._id}>
            <div className="col-lg-2 col-md-2 col-sm-2 text-right text-top align-middle pt-2 border-top border-dark">
                <span>{display}</span>
            </div>
            <div className={textDisplayClasses}>
                <form>
                    <div className="form-group">
                        <textarea time={item.time} className={"form-control " + backgroundDisplayClass + " text-dark"}
                                  defaultValue={item.details} onChange={changeHandler}></textarea>
                    </div>
                </form>
            </div>
            <div className="col-lg-2 col-md-2 col-sm-2 align-middle p-3">
